...
一致性哈希(Consistent Hashing)算法是分布式领域非常重要的算法，它的原理比较简单。其基本思想就是将对象和 cache 都映射到同一个 hash 数值空间中，并且使用相同的hash 算法。
...
![普通哈希流程](http://www.gliffy.com/go/publish/image/6119491/L.png)

#### 一致性哈希

![一致性哈希流程](http://www.gliffy.com/go/publish/image/6119600/L.png)
