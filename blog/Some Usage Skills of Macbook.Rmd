Some Usage Skills of Macbook
========================================================


### 模仿windows的［windows ＋ L]锁定电脑 control + shift + [电源开关]
...
### Mac下的Chrome或Safari如何设置可以允许Js跨域访问

关闭原有的chrome，terminal执行命令`open -a Google\ Chrome --args --disable-web-security`此时打开的chrome会提示跨域不安全。
